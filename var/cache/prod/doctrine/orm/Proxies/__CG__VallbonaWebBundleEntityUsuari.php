 ...
 */
class Usuari extends \Vallbona\WebBundle\Entity\Usuari implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Vallbona\\WebBundle\\Entity\\Usuari' . "\0" . 'id', '' . "\0" . 'Vallbona\\WebBundle\\Entity\\Usuari' . "\0" . 'nom', '' . "\0" . 'Vallbona\\WebBundle\\Entity\\Usuari' . "\0" . 'cognom', '' . "\0" . 'Vallbona\\WebBundle\\Entity\\Usuari' . "\0" . 'correo'];
        }
